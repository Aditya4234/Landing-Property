...
export default function Footer() {
    return (
        <footer id="footer" className="bg-gradient-to-br from-emerald-800 via-teal-700 to-cyan-800 text-white pt-32 pb-16">
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h4 className="font-serif text-2xl mb-12 text-white italic">Manifesto</h4>
                        <p className="text-white/40 font-light mb-10 leading-relaxed text-sm">Join our private network for exclusive early access to luxury launches.</p>
                        <div className="flex gap-4">
                            {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                                <a key={i} href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all duration-500">
