...
import { Menu, X, Home, Sun, Moon, User, LogOut } from "lucide-react";
                ...
                <nav className="hidden md:flex items-center gap-10" role="navigation" aria-label="Main navigation">
                    ...
                    {isAuthenticated ? (
                        <div className="flex items-center space-x-4">
                            <Link href="/dashboard" className="flex items-center text-[11px] font-bold text-foreground/70 uppercase tracking-[0.2em] hover:text-accent transition-colors">
                            ...
                            <button
                                ...
                                className="flex items-center text-[11px] font-bold text-foreground/70 uppercase tracking-[0.2em] hover:text-accent transition-colors"
                            >
                        ...
                        <div className="flex items-center space-x-4">
                            <Link href="/login" className="text-[11px] font-bold text-foreground/70 uppercase tracking-[0.2em] hover:text-accent transition-colors">
                                Login
                            </Link>
                            <Link href="/register" className="text-[11px] font-bold text-foreground/70 uppercase tracking-[0.2em] hover:text-accent transition-colors">
                                Register
                            </Link>
                        </div>
                    )}
                        ...
                        {isAuthenticated ? (
                            <div className="space-y-4 my-8">
                                <Link
                                    href="/dashboard"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className="flex items-center justify-center w-full py-3 bg-blue-600 text-white rounded-xl font-bold uppercase tracking-widest text-sm hover:bg-blue-700 transition-colors"
                                >
                                    <User size={16} className="mr-2" />
                                    Dashboard
                                </Link>
                                <button
                                    ...
                                    className="flex items-center justify-center w-full py-3 bg-gray-600 text-white rounded-xl font-bold uppercase tracking-widest text-sm hover:bg-gray-700 transition-colors"
                                >
                                    <LogOut size={16} className="mr-2" />
                                    Logout
                                </button>
